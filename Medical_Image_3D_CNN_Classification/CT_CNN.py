...
## function which outputs initial which is a tensor with the same shape as the input tensor
## but with random values from a truncted normal distribution, that is with a certain 
